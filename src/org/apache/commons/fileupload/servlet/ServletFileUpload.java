...
public class ServletFileUpload extends FileUpload {
	...
	public static final ThreadLocal<Long> contentLengthThreadLocal = new ThreadLocal<Long>();
    ...
    public List /* FileItem */ parseRequest(HttpServletRequest request)
    	...
    	contentLengthThreadLocal.set(Long.parseLong(request.getHeader("content-length")));
