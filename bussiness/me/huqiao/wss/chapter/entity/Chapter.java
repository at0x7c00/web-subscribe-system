...
/**
 * @param categoryQuery 要设置的分类模糊查询条件
 */
...
/**
  * @param updateTimeStart 要设置的修改时间开始日期
  */
...
/**
  * @param updateTimeEnd 要设置的修改时间结束日期
  */
...
/**
  * @param sortNumStart 要设置的排序号开始日期
  */
...
/**
 * @param cover 要设置的封面图片
 */
public void setCover(CommonFile cover){
    this.cover = cover;
}
/**
 * @param coverQuery 要设置的封面图片模糊查询条件
 */
